    ...
    class CMemoryModelLPG final : public ILPGModel
    {
      private:
        ...
        struct SVertexContainer
        {
            ...
            std::vector<SLabel> edge_labels = {};
            std::vector<std::vector<SEdgeContainer>> labelled_edges = {};
            std::vector<SProperty> properties              = {};
        };
      ...
      public:
        ...
        void add_edge(int64_t src, int64_t dst, const std::pair<std::string, std::string> & prop...) override;
      ...
      private:
        ...
        void define_labelled_vertices() noexcept;
        ...
        static constexpr int64_t MASTER_VERTEX_MAP_START_ADDR = MASTER_METADATA_START_ADDR + sizeof(SGraphMetaData);
    };
} // namespace graphquery::database::storage
