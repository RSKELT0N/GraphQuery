...
namespace graphquery::database::storage
{
	class CDiskDriver
	{
	  ...
	  public:
		...
		[[maybe_unused]] static SRet_t create_folder(const std::filesystem::path & folder_name);
		[[maybe_unused]] static SRet_t create_file(const std::filesystem::path & file_name,
												   int64_t file_size);
