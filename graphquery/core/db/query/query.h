...
namespace graphquery::database::query
{
    class CQueryEngine
    {
      public:
        ...
        ***************************************************************/
        [[nodiscard]] std::vector<std::map<std::string, std::string>> interaction_complex_2(uint64_t _person_id, uint32_t _max_date) const noexcept;
        ...
        ***************************************************************/
         ...
         *  \param _dst_person_id uint64_t- ID of person
         ***************************************************************/
