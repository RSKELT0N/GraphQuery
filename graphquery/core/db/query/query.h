...
namespace graphquery::database::query
{
    class CQueryEngine
    {
      public:
        ...
        *
        *  \param _person_id uint32_t _person_id - ID of person
        *  \param _max_date uint32_t - max date threshold
        ***************************************************************/
        [[nodiscard]] std::vector<std::map<std::string, std::string>> interaction_complex_2(uint32_t _person_id, uint32_t _max_date) const noexcept;
         ...
         *         (limited to 20)
         *
         *  \param _person_id uint32_t - ID of person
         ***************************************************************/
        [[nodiscard]] std::vector<std::map<std::string, std::string>> interation_complex_8(uint32_t _person_id) const noexcept;
         ...
         *
         *  \param _person_id uint32_t - ID of person
         *  \param _post_id uint32_t - ID of post
         ***************************************************************/
        void interation_update_2(uint32_t _person_id, uint32_t _post_id) const noexcept;

        /****************************************************************
        ** \brief Creates an edge between two nodes (person, person),
        *         with passed parameters ID parameters.
        *
        *  \param _src_person_id uint32_t - ID of src person
        *  \param _dst_person_id uint32_t - ID of dst person
        ***************************************************************/
        void interation_update_8(uint32_t _src_person_id, uint32_t _dst_person_id) const noexcept;
         ...
         ***************************************************************/
        inline void interation_delete_2(uint32_t _person_id, uint32_t _post_id) const noexcept;
         ...
         *
         *  \param _src_person_id uint32_t - ID of person
         *  \param _dst_person_id - ID of person
         ***************************************************************/
        inline void interation_delete_8(uint32_t _src_person_id, uint32_t _dst_person_id) const noexcept;
        ...
        *  \param _person_id - ID of person
s        ***************************************************************/
        void interation_short_2(uint32_t _person_id) const noexcept;
         ...
         *
         *  \param _message_id uint32_t - ID of message
         ***************************************************************/
        void interation_short_7(uint32_t _message_id) const noexcept;
