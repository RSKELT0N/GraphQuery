...
namespace graphquery::database::query
{
    ...
    public:
        ...
        ***************************************************************/
        void interaction_complex_2(storage::ILPGModel::Id_t _person_id, int64_t _max_date) const noexcept;
         ...
         ***************************************************************/
        void interaction_complex_8(storage::ILPGModel::Id_t _person_id) const noexcept;
         ...
         ***************************************************************/
        void interaction_update_2(storage::ILPGModel::Id_t _person_id, storage::ILPGModel::Id_t _post_id) const noexcept;
        ...
        ***************************************************************/
        void interaction_update_8(storage::ILPGModel::Id_t _src_person_id, storage::ILPGModel::Id_t _dst_person_id) const noexcept;
         ...
         ***************************************************************/
        void interaction_delete_2(storage::ILPGModel::Id_t _person_id, storage::ILPGModel::Id_t _post_id) const noexcept;
         ...
         ***************************************************************/
        void interaction_delete_8(storage::ILPGModel::Id_t _src_person_id, storage::ILPGModel::Id_t _dst_person_id) const noexcept;
        ...
        *  \param _person_id - ID of person
s        ***************************************************************/
        void interaction_short_2(storage::ILPGModel::Id_t _person_id) const noexcept;
         ...
         ***************************************************************/
        void interaction_short_7(storage::ILPGModel::Id_t _message_id) const noexcept;
