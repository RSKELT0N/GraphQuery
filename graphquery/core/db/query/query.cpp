...
void
graphquery::database::query::CQueryEngine::process_query([[maybe_unused]] std::string_view query) const noexcept
{
}
void
graphquery::database::query::CQueryEngine::interaction_complex_2([[maybe_unused]] uint64_t _person_id, [[maybe_unused]] uint64_t _max_date) const noexcept
{
}
void
