    ...
    class CFrameDBAnalytic : public IFrame
    {
      public:
        CFrameDBAnalytic(const bool & is_db_loaded,
                         ...
                         std::shared_ptr<std::vector<database::analytic::CAnalyticEngine::SResult>>,
